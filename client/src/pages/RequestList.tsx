      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500">Manage and track your project certifications.</p>
          </div>
        ...
        <div className="flex gap-4 p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
          <div className="relative flex-1">
            ...
            <Input placeholder="Search requests..." className="pl-10 border-gray-200" />
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50/50 border-b border-gray-100 text-left">
                  <tr>
                    <th className="py-4 px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">Project Info</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  {requests?.map((req) => (
                    <tr key={req.id} className="hover:bg-gray-50 transition-colors group">
                      ...
                      {profile?.role === 'admin' && (
                        <td className="py-4 px-6 text-sm text-gray-500">
                          {req.user?.organizationName || "Unknown"}
                        </td>
                      )}
